...
<div id="mainContent" class=" p-8 absolute top-1 ">
    ...
    <h3 class="text-md font-medium mb-4">Create Notice</h3>

    <form action="insert_notice.php" method="POST" class="space-y-7">
        ...
        <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4 ">
            ...
            <input type="text" name="title" placeholder="Enter Notice Title Here"  required
        ...
        <div class="lg:flex md:flex items-start lg:space-x-4 md:space-x-4 ">
            ...
            <textarea  name="short_desc" placeholder="Enter Short Description"  required
                       class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" ></textarea>
        </div>
        ...
        <textarea name="long_desc" id="long_desc" required
                  class="form-control rounded-none border border-gray-300 focus:border-[#01a9ac]"></textarea>
            </div>
        </div>
