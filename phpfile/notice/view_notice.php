...
<div id="mainContent" class=" p-8 absolute top-1 ">
    <h1 class="font-medium text-[22px]">View Notice</h1>
    <span>
...
<div class="w-full mx-auto bg-white shadow rounded-md p-6 border-t-4 border-teal-500 ">
    <h1 class="text-md font-medium">Notice Details</h1>
    <div class="grid grid-cols-12 gap-5 pb-6 mt-10">
        <div class="lg:col-span-4 md:col-span-4 sm:col-span-4 col-span-4 space-y-4">
            <h5 class="text-md font-medium  leading-relaxed tracking-wide text-end">Title:</h5>
            <h5 class="text-md font-medium  leading-relaxed tracking-wide text-end">Short Description:</h5>
            <h5 class="text-md font-medium  leading-relaxed tracking-wide text-end">Long Description:</h5>
            <h5 class="text-md font-medium  leading-relaxed tracking-wide text-end">Published Date:</h5>
        </div>
        <div class="lg:col-span-6 md:col-span-6 sm:col-span-5 col-span-5 space-y-4">
            <p class="text-gray-700 text-md "><?= htmlspecialchars($row['title']) ?></p>
            <p class="text-gray-700 text-md"><?= htmlspecialchars($row['short_desc']) ?></p>
            <p class="text-gray-700 text-md"><?= $row['long_desc'] ?></p>

           <p class="text-[#fe5d70] pt-2"> <span class="<?= $row['status'] === 'Published'  ?>">
            <?= $row['status'] ?>
        </span>
            &nbsp; | &nbsp;
