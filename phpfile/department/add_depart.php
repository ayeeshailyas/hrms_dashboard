...
<?php
// MySQLi connection
$connection = mysqli_connect("localhost", "root", "", "hrms_dashboard");
...
<!--        <p class="float-left text-[14px] text-[#919aa3] pt-2">Notice Board</p>-->
    ...
    <div class="mx-auto bg-white p-6 w-full   rounded shadow-[0_1px_20px_0_rgba(69,90,100,0.08)] ">
        <!-- Toast Notification -->
        <div id="successToast" class="fixed top-6 right-6 bg-black bg-opacity-80 text-white text-sm px-5 py-4 rounded shadow-lg z-50 transform translate-x-full opacity-0 transition-all duration-500 ease-in-out flex items-center gap-2">
            Department Information Saved Successfully
        </div>

        <!-- Form -->
        <form id="departmentForm" method="POST" class="space-y-4 py-4">
            ...
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4 ">
                ...
                <input type="text" name="department" placeholder="Enter Your Department"  required
                       class=" py-1 px-3 lg:w-[50%] md:w-[50%] sm:w-[50%] w-full rounded-none border border-gray-300 focus:border-[#01a9ac]"  />
            </div>

            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4 ">
                <label class="w-48 text-[15px]  text-gray-700 sm:pb-2 lg:pb-0 md:pb-0 pb-2 ">Add Designation <span class="text-red-500">*</span></label>
                <input type="text" name="designations[]" placeholder="Enter Your Designations" required
                       class="lg:w-[50%] md:w-[50%] sm:w-[50%] w-full py-1 px-3  rounded-none border border-gray-300 focus:border-[#01a9ac]"  />
                <button type="button" onclick="addDesignation()" class="text-sm text-[#404E67] hover:text-[#01a9ac] font-bold whitespace-nowrap"><i class="fa fa-plus"></i> Add More</button>
            </div>

            <!-- Dynamic Designations -->
            <div id="designationsContainer" class="space-y-4"></div>
...
<!--add more designation-->
    <script>
        function addDesignation() {
            ...
            div.innerHTML = `
            <label class="w-48 text-[15px] text-gray-700 sm:pb-2 lg:pb-0 md:pb-0 pb-2 ">Add Designation *</label>
