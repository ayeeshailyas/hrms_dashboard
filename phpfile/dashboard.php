...
<style>
    ...
    .mobile-headermdsm.open {
        max-height: 300px;
        opacity: 1;
        padding: 2px; /* same as default to give space for content */
        overflow: visible;
        transition: max-height 0.5s ease-in-out, opacity 0.3s ease-in-out, padding 0.3s ease-in-out;
...
<div id="mainContent" class=" p-8 absolute top-1 ">
    <h1 class="font-semibold text-[24px]">Dashboard</h1>
    <span>
    <p class="text-[#919aa3] text-[14px] pt-2 float-left">dashboard</p>
