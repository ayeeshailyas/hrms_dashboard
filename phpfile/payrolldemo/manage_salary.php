...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $designation_combined = $_POST['designation_combined'];
    list($department, $designation) = explode("||", $designation_combined);
    ...
    $gross = $basic + $house + $medical + $special + $fuel + $phone + $other_allowance;
        ...
        <div class="w-full  mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
            ...
            <div class="space-y-4">
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <div class="w-[380px]">
                        <select name="designation_combined" id="designationDropdown"
                                class="selectpicker form-control rounded" data-live-search="true" required>
                ...
                <div class="col-md-6">
                    <div class="w-full mx-auto bg-white shadow p-6 rounded-md ">
                        <div class="space-y-1">
                            ...
                            <label class="w-48 text-[15px] text-gray-700">House Rent <span class="text-red-500">*</span></label>
                    ...
                    <div class="w-full mx-auto bg-white shadow p-6 rounded-md ">
                        <div class="space-y-1">
                            <h1 class="font-semibold pt-2 pb-3">Total Salary Details</h1>

                    <div class="mt-2">
                        <label class="text-[15px] text-gray-700">Gross Salary</label>
                        <input type="text" class="form-control mb-2 text-gray-400 rounded-none bg-[#F6F7FB] focus:bg-[#F6F7FB] cursor-not-allowed" name="gross_salary" id="gross_salary" readonly>
                        <label class="text-[15px] text-gray-700">Total Deductions</label>
                        <input type="text" class="form-control mb-2 text-gray-400 rounded-none bg-[#F6F7FB] focus:bg-[#F6F7FB] cursor-not-allowed" name="total_deduction" id="total_deduction" readonly>
                        <label class="text-[15px] text-gray-700">Net Salary</label>
                        <input type="text" class="form-control rounded-none text-gray-400 bg-[#F6F7FB] focus:bg-[#F6F7FB] cursor-not-allowed" name="net_salary" id="net_salary" readonly>
                    </div>
                        </div>
                    </div>
