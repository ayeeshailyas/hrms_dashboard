...
<div id="mainContent" class=" p-8 absolute top-1 ">
    ...
    <div class="float-right">
            <a href="edit_salary.php?id=<?= $row['emp_id'] ?>"
               class="float-right bg-[#01a9ac] text-white -mt-2 text-[14px] px-3 py-2.5  hover:bg-[#07e4e8] transition-all duration-300"><i
                        class="fa fa-edit"></i> Edit</a>
             <a href="#" onclick="generatePDF()"
                class="bg-[#01a9ac] text-white text-[14px] px-3 py-2.5  hover:bg-[#07e4e8] transition-all duration-300"> <i
                         class="fa fa-file-pdf-o"></i></a>
             <a href="#" onclick="window.print()"
                class="bg-[#01a9ac] text-white text-[14px] px-3 py-2.5  hover:bg-[#07e4e8] transition-all ml-1 mr-2 duration-300"> <i
        ...
        <div class="grid grid-cols-12 gap-4 items-center pb-5">
            <div class="lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12 lg:flex lg:justify-center lg:items-center md:flex md:justify-center md:items-center sm:flex sm:justify-start sm:items-start flex justify-start items-start ">
                <img src="../employee/uploads/<?= htmlspecialchars($row['photo']) ?>" alt="Profile"
            ...
            <div class="lg:col-span-8 md:col-span-8 sm:col-span-12 col-span-12">
                ...
                <div class="space-y-2 text-gray-700 text-[15px]">
                    <div class="hover:bg-gray-200 w-[280px] px-2 ">
                        <p class="text-[#353c4e]"><strong class="pr-10">Employee
                                ID:</strong> <?= htmlspecialchars($row['emp_id']) ?></p>
                    </div>
                    <div class="hover:bg-gray-200 w-[280px] px-2">
                        <p class="text-[#353c4e]"><strong
                                    class="pr-10">Department:</strong> <?= htmlspecialchars($row['department']) ?></p>
                    </div>
                    <div class="hover:bg-gray-200 w-[280px] px-2">
                        <p class="text-[#353c4e]"><strong
                                    class="pr-10">Designation:</strong> <?= htmlspecialchars($row['designation']) ?></p>
                    </div>
                    <div class="hover:bg-gray-200 w-[280px] px-2 ">
                        <p class="text-[#353c4e]"><strong class="pr-10">Joining
                                Date:</strong> <?= htmlspecialchars($row['join_date']) ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
        <h3 class="text-lg font-medium mb-6 border-b pb-2">Salary Details</h3>


        <div class="grid grid-cols-12 pt-2">
            <div class="col-span-3">
                <div class="space-y-5">
                    <p class="font-medium text-[#353c4e]">Enrollment Type:</p>
                    <p class="font-medium text-[#353c4e]">Basic Salary:</p>

                </div>
            </div>
            <div class="col-span-6">
                <div class="space-y-5">
                    <p><?= htmlspecialchars($row['enrollment_type']) ?></p>
                    <p><?= number_format($row['basic_salary'], 2) ?></p>
    ...
    <div class="grid grid-cols-12 gap-4 pb-5">
        <div class="lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                <h3 class="text-lg font-medium mb-6 border-b pb-2">Allowances</h3>

                <div class="grid grid-cols-12">
                    <div class="col-span-6">
                        <div class="space-y-8">
                            <p class="font-medium text-[#353c4e]">House Rent Allowence:</p>
                            <p class="font-medium text-[#353c4e]">Medical Allowance :</p>
                            <p class="font-medium text-[#353c4e]">Special Allowance :</p>
                            <p class="font-medium text-[#353c4e]">Fuel Allowance :</p>
                            <p class="font-medium text-[#353c4e]">Phone Bill Allowance :</p>
                            <p class="font-medium text-[#353c4e]">Other Allowance :</p>
                        </div>
                    </div>
                    <div class="col-span-6">
                        <div class="space-y-8">
                            <p><?= number_format($row['house_allowance'], 2) ?> </p>
                            <p><?= number_format($row['medical_allowance'], 2) ?> </p>
                            <p><?= number_format($row['special_allowance'], 2) ?></p>
                            <p><?= number_format($row['fuel_allowance'], 2) ?></p>
                            <p><?= number_format($row['phone_allowance'], 2) ?></p>
                            <p><?= number_format($row['other_allowance'], 2) ?></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                <h3 class="text-lg font-medium mb-6 border-b pb-2">Total Salary Details</h3>


                <div class="grid grid-cols-12">
                    <div class="col-span-5">
                        <div class="space-y-8">
                            <p class="font-medium text-[#353c4e]">Gross Salary:</p>
                            <p class="font-medium text-[#353c4e]">Total Deduction:</p>
                            <p class="font-medium text-[#353c4e]">Net Salary:</p>

                        </div>
                    </div>
                    <div class="col-span-5">
                        <div class="space-y-8">
                            <p><?= number_format($row['gross_salary'], 2) ?></p>
                            <p><?= number_format($row['total_deduction'], 2) ?></p>
                            <p><?= number_format($row['net_salary'], 2) ?></p>
                        </div>
                    </div>
                </div>


                <!--        <a href="employee_salary_list.php" class="btn btn-secondary mt-4">Back to List</a>-->
            </div>
        ...
        <div class="lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                ...
                <div class="grid grid-cols-12">
                    <div class="col-span-5">
                        <div class="space-y-8">
                            <p class="font-medium text-[#353c4e]">Provident Fund :</p>
                            <p class="font-medium text-[#353c4e]">Tax Deduction :</p>
                            <p class="font-medium text-[#353c4e]">Other Deduction :</p>

                        </div>
                    </div>
                    <div class="col-span-6">
                        <div class="space-y-8">
                            <p><?= number_format($row['provident_fund'], 2) ?></p>
                            <p><?= number_format($row['tax_deduction'], 2) ?></p>
                            <p><?= number_format($row['other_deduction'], 2) ?></p>
