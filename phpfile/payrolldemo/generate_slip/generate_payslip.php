...
<div id="mainContent" class=" p-8 absolute top-1 ">
    ...
    <form method="POST">
        <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-wrap items-center  relative">
                    <label class="text-gray-700 w-64 lg:-mt-5 md:-mt-5 sm:-mt-5 -mt-5">Select Month <span
                                class="text-red-500">*</span></label>
                    <div class="w-[380px] flex items-center  lg:ml-2 md:ml-2 sm:ml-0 ml-0 relative">
                        <input id="dobInput" name="award_month" placeholder="YYYY-MM" readonly
                               class="w-full px-3 py-2 border lg:-mt-4 md:-mt-4  focus:outline-none focus:ring-2 focus:ring-teal-500">

                        <div class="absolute right-2 text-teal-600 lg:-top-1 md:-top-1">
        ...
        <div class="py-4"></div>
        <!-- Section 2 -->
        <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500" id="salarySection" style="display: none;">
            <h4>Generate Payslip for <span class="hidden font-semibold text-[#fe5d70] mb-3" id="payslipHeading"></span></h4>
            <div class="py-2"></div>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th class="font-medium">Net Salary</th>
                    <th class="font-medium">Gross Salary</th>
                    <th class="font-medium">Total Deduction</th>
