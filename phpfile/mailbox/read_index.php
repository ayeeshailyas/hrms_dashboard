...
<style>
    ...
    /* Styling for the reply box with the resize handle line */
    .reply-box-container {
        position: relative;
    ...
    /* Resize handle line at the bottom-right */
    .resize-line {
        width: 10px;
        height: 2px;
        ...
        <div class="flex items-center gap-9">
            ...
            <div class="relative inline-block text-left">
                ...
                <div id="dopdownMenu" class="hidden absolute top-[70px] -right-[15px] w-[23rem] bg-[#fff] border border-gray-200 rounded-md shadow-lg z-50">
                    ...
                    <!-- Dropdown Body -->
                    <div id="notificationList" class="px-3 py-7 text-[14px] mb-[1rem] font-semibold text-center hover:bg-gray-100 hover:text-gray-800 cursor-pointer transition-colors duration-200">
                        <p>No new messages</p>
                    </div>
                </div>
            </div>
...
<div id="mainContent" class=" p-8 absolute -top-5 ">
    ...
    <div id="emailDetailContainer"></div>
    ...
    <script>
        window.onload = function () {
            ...
            if (email) {
                document.getElementById("emailDetailContainer").innerHTML = `
                <div class="mx-auto p-6 bg-white rounded-md">
                    <!-- Subject + Time -->
                    <div class="flex justify-between items-start mb-2">
                        <p class="text-base font-semibold text-gray-800">${email.subject}</p>
                        <p class="text-sm text-gray-600">${email.time}</p>
                    </div>

                    <!-- Sender -->
                    <div class="flex items-center mb-3">
                        <img src="images/img.png" class="w-[40px] h-[40px] rounded-[2px] mr-4" alt="Avatar">
                        <div>
                            <p class="text-gray-800 font-medium">John Doe</p>
                            <p class="text-sm text-gray-600">From: ${email.email}</p>
                        </div>
                    </div>
                  <div class="lg:pl-[3.5rem]">
                    <!-- Message -->
                    <p class="font-medium text-gray-700 mb-2 text-sm">Hello Dear...</p>
                    <hr class="my-5">
                    <p class="text-gray-700 mb-4">${email.message}</p>
                       <div class="py-3"></div>
                    <!-- Attachments -->
                    <div class="mb-4">
...
<!--                                      d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828L18 9.828M6.343 17.657a8 8 0 1111.314 0 8 8 0 01-11.314 0z" />-->
<!--                            </svg>-->
        <span class="text-sm text-gray-700 pr-2"><i class="fas fa-paperclip"></i></span>
                            <span class="text-md  tracking-wide font-medium text-gray-700">Attachments (${email.attachments.length})</span>
                        </div>

                        <div class="flex space-x-4 pt-3">
                            ${email.attachments.map(att => `
                                <img src="images/img_1.png" class="email-image p-1 rounded-[2px]" alt="${att}">
                            `).join("")}
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="reply-box-container">
                            <textarea class="reply-box" placeholder="Reply Your Thoughts..."></textarea>
            ...
            `;
                ...
                document.getElementById("emailDetailContainer").innerHTML = `<p>Email not found.</p>`;
            }
        };
    </script>
