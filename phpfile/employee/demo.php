    ...
    <div class="flex flex-col space-y-2">
        ...
        <ul class="pt-3">
            ...
            <ul id="dropdown1" class="transition-all max-h-0   overflow-hidden">
                ...
                <li class="pb-2 lg:pl-7 md:pl-7 sm:pl-6 pl-6 pt-3"><a
                            href="http://localhost/project/hrms_dashboard/phpfile/settings(1).php"
                ...
                <li class="pb-2 lg:pl-7 md:pl-7 sm:pl-6 pl-6"><a
                            href="http://localhost/project/hrms_dashboard/phpfile/settings(2).php"
                            class="dropdown-item  text-[15px] hover:text-[#FE8A7D] text-[#dcdcdc] pb-2 "><i
                ...
                <li class="pb-2 lg:pl-7 md:pl-7 sm:pl-6 pl-6"><a href="#"
                                                                 class="dropdown-item  text-[15px] hover:text-[#FE8A7D] text-[#dcdcdc] pb-2 "><i
        ...
        <ul class="pt-3">
            ...
            <ul id="dropdown2" class="transition-all max-h-0   overflow-hidden ">
                ...
                <li class="pb-2 lg:pl-6 md:pl-6 sm:pl-6 pl-6 pt-3"><a href="#"
                                                                      class="dropdown-item  text-[15px] hover:text-[#FE8A7D] text-[#dcdcdc] pb-2 "><i
                                class="fa fa-angle-right font-bold pr-2"></i>Add Department</a></li>

                <li class="pb-2 lg:pl-6 md:pl-6 sm:pl-6 pl-6"><a href="#"
                                                                 class="dropdown-item  text-[15px] hover:text-[#FE8A7D] text-[#dcdcdc] pb-2 "><i
        ...
        <ul class="pt-3">
            ...
            <ul id="dropdown3" class="transition-all max-h-0   overflow-hidden  ">
                ...
                <li class="pb-2 pl-7 pt-3"><a href="#"
                                              class="dropdown-item  text-[15px] hover:text-[#FE8A7D] text-[#dcdcdc] pb-2 "><i
...
<div id="mainContent" class=" p-8 absolute top-1 ">
    ...
    <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
        <h3 class="text-md font-medium mb-4">Employee Detail</h3>
        <div class="space-y-4">
                ...
                <div class="col-span-4">
                    <?php if (!empty($row['photo'])): ?>
                        <img src="uploads/<?= urlencode($row['photo']) ?>" alt="Employee Photo"
                             class="employee-photo mt-3">
                        <div class="text-muted mt-2">Photo</div>
                    <?php else: ?>
                        <p class="text-muted">No Photo Uploaded</p>
                    <?php endif; ?>
                </div>
                <div class="col-span-8">
                    <p><strong>Employee ID:</strong> <?= htmlspecialchars($row['emp_id']) ?></p>
                    <p><strong>Name:</strong> <?= htmlspecialchars($row['f_name'] . ' ' . $row['l_name']) ?></p>
                    ...
                    <p><strong>Joining Date:</strong> <?= htmlspecialchars($row['join_date']) ?></p>
                </div>
            </div>
        ...
        <div class="lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                ...
                <div class="space-y-4">
                    ...
                    <p><strong>Marital Status:</strong> <?= htmlspecialchars($row['marital_status']) ?></p>
            ...
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                <h3 class="text-md font-medium mb-4">Emplyee Documents</h3>
                <div class="space-y-4">
                    ...
                    foreach ($documents as $key => $label):
                        if (!empty($row[$key])):
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <a href="<?= $filePath ?>" class="btn btn-sm btn-outline-primary ms-2" target="_blank">View</a>
                            </div>
                        <?php endif;
                    endforeach; ?>
        ...
        <div class="lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                ...
                <div class="space-y-4">
                    ...
                    <p><strong>Country:</strong> <?= htmlspecialchars($row['contact_nationality']) ?></p>
            ...
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                ...
                <div class="space-y-4">
                    ...
                    <p><strong>Branch Name:</strong> <?= htmlspecialchars($row['branch_name']) ?></p>
