...
<div id="mainContent" class=" p-8 absolute top-1 ">
    ...
    <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
         <span>
        <h3 class="text-lg font-medium mb-4 float-left">Employee Detail</h3>
    <div class="float-right">
            <a href="edit_employee.php?id=<?= $row['id'] ?>" class="float-right bg-[#01a9ac] text-white -mt-2 text-[14px] px-3 py-2.5  hover:bg-[#07e4e8] transition-all duration-300"><i class="fa fa-edit"></i> Edit</a>
             <a href="#" onclick="generatePDF()" class="bg-[#01a9ac] text-white text-[14px] px-3 py-2.5  hover:bg-[#07e4e8] transition-all duration-300"> <i class="fa fa-file-pdf-o"></i></a>
             <a href="#" onclick="window.print()" class="bg-[#01a9ac] text-white text-[14px] px-3 py-2.5  hover:bg-[#07e4e8] transition-all ml-1 mr-2 duration-300"> <i class="fa fa-print"></i></a>
</div>
         </span>


<div class="py-7"></div>
            <div class="grid grid-cols-12 gap-4 items-center pb-5">
                <!-- Photo Section -->
                <div class="lg:col-span-4 md:col-span-4 sm:col-span-12 col-span-12 lg:flex lg:justify-center lg:items-center md:flex md:justify-center md:items-center sm:flex sm:justify-start sm:items-start flex justify-start items-start ">
                    <?php if (!empty($row['photo'])): ?>
                        <img src="uploads/<?= urlencode($row['photo']) ?>" alt="Employee Photo"
                             class="employee-photo w-40 h-40 object-cover shadow-md border border-gray-300">
                    <?php else: ?>
                ...
                <div class="lg:col-span-8 md:col-span-8 sm:col-span-12 col-span-12">
                    <p class="text-2xl font-semibold text-[#353c4e] mb-2">
                        <?= htmlspecialchars($row['f_name'] . ' ' . $row['l_name']) ?>
                    </p>
                    <hr class="border-t-2 border-gray-300 mb-4">

                    <div class="space-y-2 text-gray-700 text-[15px]">
                        <div class="hover:bg-gray-200 w-[280px] px-2 ">
                            <p class="text-[#353c4e]"><strong class="pr-10">Employee ID:</strong> <?= htmlspecialchars($row['emp_id']) ?></p>
                        </div>
                        <div class="hover:bg-gray-200 w-[280px] px-2">
                            <p class="text-[#353c4e]"><strong class="pr-10">Department:</strong> <?= htmlspecialchars($row['department']) ?></p>
                        </div>
                        <div class="hover:bg-gray-200 w-[280px] px-2">
                            <p class="text-[#353c4e]"><strong class="pr-10">Designation:</strong> <?= htmlspecialchars($row['designation']) ?></p>
                        </div>
                        <div class="hover:bg-gray-200 w-[280px] px-2 ">
                            <p class="text-[#353c4e]"><strong class="pr-10">Joining Date:</strong> <?= htmlspecialchars($row['join_date']) ?></p>
                        </div>
                    </div>
    ...
    <div class="grid grid-cols-12 gap-4 pb-5">
        <div class="lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                <h3 class="text-lg font-medium mb-6 border-b pb-2">Personal Details</h3>


                    <div class="grid grid-cols-12">
                        <div class="col-span-5">
                            <div class="space-y-4">
                            <p class="font-medium text-[#353c4e]">Date of Birth</p>
                            <p class="font-medium text-[#353c4e]">Gender </p>
                            <p class="font-medium text-[#353c4e]">Marital Status </p>
                            <p class="font-medium text-[#353c4e]">Father's Name </p>
                            <p class="font-medium text-[#353c4e]">Nationality </p>
                            <p class="font-medium text-[#353c4e]">Passport No </p>
                            </div>
                        </div>
                        <div class="col-span-6">
                            ...
                            <p> <?= htmlspecialchars($row['marital_status']) ?></p>
                            <p><?= htmlspecialchars($row['father_name']) ?> </p>
                            <p><?= htmlspecialchars($row['nationality']) ?> </p>
                            <p><?= htmlspecialchars($row['passport_no']) ?> </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                <h3 class="text-lg font-semibold text-gray-800 mb-6 border-b pb-2">Employee Documents</h3>
                <div class="grid grid-cols-1 gap-4">
                    ...
                    foreach ($documents as $key => $label):
                        if (!empty($row[$key])):
                            $filePath = 'uploads/' . urlencode($row[$key]);
                            ?>
                            <div class="flex items-center justify-between bg-gray-50 p-3 rounded shadow-sm border hover:shadow-md transition-all duration-200">
                                <span class="text-gray-700 font-medium"><?= $label ?>:</span>
                                <a href="<?= $filePath ?>" class="text-sm  text-black   px-4 py-1 " target="_blank">View</a>
                            </div>
                        <?php endif;
                    endforeach;
                    ?>
        ...
        <div class="lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12 pb-5">
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                <h3 class="text-lg font-medium mb-6 border-b pb-2">Contact Details</h3>
                <div class="grid grid-cols-12">
                    <div class="col-span-5">
                        <div class="space-y-4">
                            <p class="font-medium text-[#353c4e]">Address</p>
                            <p class="font-medium text-[#353c4e]">City</p>
                            <p class="font-medium text-[#353c4e]">Country</p>
                            <p class="font-medium text-[#353c4e]">Mobile</p>
                            <p class="font-medium text-[#353c4e]">Phone</p>
                            <p class="font-medium text-[#353c4e]">Email</p>
                        </div>
                    </div>
                    <div class="col-span-6">
                        <div class="space-y-4">
                            ...
                            <p> <?= htmlspecialchars($row['contact_nationality']) ?></p>
            ...
            <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                <h3 class="text-lg font-medium mb-6 border-b pb-2">Bank Information</h3>

                <div class="grid grid-cols-12">
                    <div class="col-span-5">
                        <div class="space-y-4">
                            <p class="font-medium text-[#353c4e]">Bank Name</p>
                            <p class="font-medium text-[#353c4e]">Branch Name</p>
                            <p class="font-medium text-[#353c4e]">Account Name</p>
                            <p class="font-medium text-[#353c4e]">Account Number</p>
                        </div>
                    </div>
                    <div class="col-span-6">
                        <div class="space-y-4">
                            <p><?= htmlspecialchars($row['bank_name']) ?> </p>
                            <p><?= htmlspecialchars($row['branch_name']) ?> </p>
                            <p> <?= htmlspecialchars($row['account_name']) ?></p>
                            <p><?= htmlspecialchars($row['account_number']) ?> </p>
                        </div>
                    </div>
                </div>
