                ...
                <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="f_name" required class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>

                        <div>
                            <label class="w-48 text-[15px] text-gray-700">Last Name <span class="text-red-500">*</span></label>
                            <input type="text" name="l_name" required class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>

<!--                        <div>-->
<!--                            <label class="w-48 text-[15px] text-gray-700">Date of Birth <span class="text-red-500">*</span></label>-->
<!--                            <input type="date" name="dob" required class="form-control w-full rounded-none py-1 border border-gray-300" />-->
<!--                        </div>-->
                        ...
                        <div class="relative">
                            ...
                            <div class="w-full flex items-center relative">
                                <input id="dobInput1" name="dob" placeholder="YYYY-MM"  value="<?php echo date('Y-m-d'); ?>" readonly
                        ...
                        <div>
                            ...
                            <input type="text" name="father_name" required class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>

                        <div>
                            <label class="w-40 text-[15px] text-gray-700">Nationality</label>
                            <select name="nationality" class="selectpicker form-control rounded-none w-full text-sm "  data-live-search="true" title="Select Country">
                        ...
                        <div>
                            ...
                            <input type="text" name="pass_no" required class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>
                ...
                <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="bank_name" class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>

                        <div>
                            <label class="w-48 text-[14px] text-gray-700">Branch Name</label>
                            <input type="text" name="branch_name" class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>

                        <div>
                            <label class="w-48 text-[14px] text-gray-700">Account Name</label>
                            <input type="text" name="account_name" class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>

                        <div>
                            <label class="w-48 text-[14px] text-gray-700">Account Number</label>
                            <input type="text" name="account_number" class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="address" required class="w-full form-control rounded-none border border-gray-300"></textarea>
                        </div>

                        <div>
                            <label class="w-48 text-[15px] text-gray-700">City <span class="text-red-500">*</span></label>
                            <input type="text" name="city" required class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="mobile" required class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>

                        <div>
                            <label class="w-48 text-[15px] text-gray-700">Phone <span class="text-red-500">*</span></label>
                            <input type="text" name="phone" required class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>

                        <div>
                            <label class="w-48 text-[15px] text-gray-700">Email <span class="text-red-500">*</span></label>
                            <input type="email" name="email" required class="form-control w-full rounded-none py-1 border border-gray-300" />
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full mx-auto bg-white shadow p-6 rounded-md border-t-4 border-teal-500">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class=" relative">
                            ...
                            <div class="w-full flex items-center   relative">
                                <input id="dobInput" name="join_date" placeholder="YYYY-MM" value="<?php echo date('Y-m-d'); ?>" readonly
                                       class="w-full px-3 py-2 border  focus:outline-none focus:ring-2 focus:ring-teal-500">
                                <div class="absolute right-2 text-teal-600 ">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                         stroke="currentColor">
                        ...
                        // SQL query to group designations under department
                        ...
                        <select name="designation_combined" class="selectpicker form-control rounded-[2px] w-full" data-live-search="true">
                            ...
                            <?php
                            foreach ($grouped as $department => $designations) {
                                echo "<option disabled class='bg-gray-100 font-medium text-black'>$department</option>";
                                foreach ($designations as $designation) {
                                    echo "<option value='" . $department . "||" . $designation . "'>&nbsp;&nbsp;&nbsp;" . $designation . "</option>";
                                }
                            }
                            ?>
                        </select>
