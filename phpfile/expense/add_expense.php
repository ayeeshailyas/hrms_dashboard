...
<div id="mainContent" class=" p-8 absolute top-1 ">
    <h1 class="font-semibold text-[24px]">Add Expense</h1>
    <span>
    ...
    <div class="w-full mx-auto bg-white shadow-md border-t-4 border-teal-500 rounded p-6">
    <h2 class="text-sm font-medium mb-4">Add Expense</h2>
    <form action="insert_expense.php" method="POST" enctype="multipart/form-data" class="space-y-4">
        <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4 ">
            <label class="w-40 text-[15px]  text-gray-700 sm:pb-2 lg:pb-0 md:pb-0 pb-2">Item Name <span class="text-red-500">*</span></label>
       ...
       <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4 ">
            <label class="w-40 text-[15px]  text-gray-700 sm:pb-2 lg:pb-0 md:pb-0 pb-2">Purchased From</label>
            <input type="text" name="purchased_from" placeholder="Enter Purchased From"  required
                   class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
        </div>

<!---->
<!--        <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">-->
<!--            <label class="w-40 text-[15px]  text-gray-700 sm:pb-2 lg:pb-0 md:pb-0 pb-2">Purchase Date <span class="text-red-500">*</span></label>-->
<!--            <input type="date" name="purchase_date" placeholder="Enter Purchase Date" required-->
<!--                   class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />-->
<!--        </div>-->


        <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4 relative">
            <label class="text-gray-700 w-40 ">Purchase Date <span class="text-red-500">*</span></label>
            <div class="w-full flex items-center  relative">
                <input id="dobInput" name="purchase_date" placeholder="YYYY-MM" readonly
         ...
         <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
            <label class="w-40 text-[15px]  text-gray-700 sm:pb-2 lg:pb-0 md:pb-0 pb-2">Amount Spent <span class="text-red-500">*</span></label>
            <input type="number" name="amount_spent" placeholder="Enter Amount " required
                   class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
        </div>
        ...
        <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
            ...
            <select name="employee_id" class="selectpicker form-control rounded-none w-full" data-live-search="true" title="Select Employee" required>
                <option value="">Select Employee...</option>
                <?php
                // Assuming $conn is already defined
                $result = $conn->query("SELECT id, f_name, l_name FROM employee ORDER BY f_name ASC");
        ...
        <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
            <label class="w-40 text-[15px]  text-gray-700 sm:pb-2 lg:pb-0 md:pb-0 pb-2">Bill Copy <span class="text-red-500">*</span></label>
            <input type="file" name="bill_copy" required
                   class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
        </div>


        <div class="text-start pt-2 lg:pl-[9.4rem] md:pl-[9.4rem] sm:pl-0 pl-0">
            <button type="submit" class="bg-[#01a9ac] hover:bg-[#07e4e8] text-white text-sm px-3 py-2 transition-all duration-300">Save</button>
        </div>
...
<script>
    ...
    // In your calendar script, modify the actionBtn click handler:
    actionBtn.onclick = () => {
        if (gridView.classList.contains("hidden")) {
            currentDate = new Date(tempDate);
