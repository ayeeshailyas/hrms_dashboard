...
<div id="mainContent" class=" p-8 absolute top-1 ">
    ...
    <div class="w-full bg-white rounded p-6">
        <h1 class="font-semibold">Add Holiday</h1>
        <div class="py-3"></div>
        <form method="post" class="space-y-4">
            ...
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                ...
                <textarea name="description" required class="form-control border border-gray-300 focus:border-[#01a9ac] w-full rounded-none"></textarea>
            </div>
...
<!--            </div>-->
            ...
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4  relative">
                ...
                <div class="w-full flex items-center  lg:ml-2 md:ml-2 sm:ml-0 ml-0 relative">
                    <input id="dobInput" name="start_date" placeholder="YYYY-MM" readonly
            ...
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4 relative">
                ...
                <div class="w-full flex items-center lg:ml-2 md:ml-2 sm:ml-0 ml-0 relative">
                    <input id="dobInput1" name="end_date" placeholder="YYYY-MM" readonly
                           class="w-full px-3 py-2 border focus:outline-none focus:ring-2 focus:ring-teal-500">
                    <div class="absolute right-2 text-teal-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor">
