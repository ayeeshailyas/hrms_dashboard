...
<div id="mainContent" class=" p-8 absolute top-1 ">
    <h1 class="font-semibold text-[24px]">Working Days</h1>
    <span>
    <p class="text-[#919aa3] text-[14px] pt-2 float-left">Set Working Days</p>
    ...
    <div class="w-full  mx-auto bg-white p-6 md:p-8 rounded shadow">
        <form>
            <!-- For SM: flex-col | For MD and above: flex-row wrap -->
            <div class="flex flex-col sm:flex-col md:flex-row flex-wrap gap-4">
                <!-- Day Items -->
                <label class="flex items-center space-x-2 cursor-pointer group">
                    <div class="relative">
                        <input type="checkbox" class="absolute opacity-0 h-0 w-0 peer">
                        <div class="checkbox-container w-6 h-6 border-2 border-[#01a9ac] flex items-center justify-center">
                            <svg class="checkmark w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" stroke-width="3" stroke-linecap="round" stroke-linejoin="round">
                                <path class="checkmark-path" d="M20 6L9 17l-5-5" style="stroke-dasharray: 30; stroke-dashoffset: 30;" />
                            </svg>
                        </div>
                    </div>
                ...
                <!-- Duplicate the above block and just change the text -->
                <label class="flex items-center space-x-2 cursor-pointer group">
                    <div class="relative">
                        <input type="checkbox" class="absolute opacity-0 h-0 w-0 peer">
                        <div class="checkbox-container w-6 h-6 border-2 border-[#01a9ac] flex items-center justify-center">
                ...
                <!-- Save Button -->
                <div >
                    <button type="submit" class="bg-[#01a9ac] hover:bg-[#018f91] text-white px-6 py-2 rounded">
                        Save
                    </button>
                </div>
            </div>
...
<script>
    document.querySelectorAll('input[type="checkbox"]').forEach(checkbox => {
        checkbox.addEventListener('change', function() {
            ...
            const path = box.querySelector('.checkmark-path');
...
<script>
    function showAlert(event) {
        ...
        // Reset animation
        alertBox.classList.remove('animate-slide-in-right');
        void alertBox.offsetWidth; // reflow hack to restart animation
        alertBox.classList.add('animate-slide-in-right');
