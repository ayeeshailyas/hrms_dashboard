...
<!-- ✅ Success Alert -->
<?php if ($showAlert): ?>
    <div id="successAlert" class="fixed top-5 right-5 bg-black text-white px-6 py-3 rounded shadow-md z-50 alert-slide-in">
...
<div id="mainContent" class=" p-8 absolute top-1 ">
    ...
    <!-- Event List Header -->
    <div class="w-full mx-auto bg-white p-6 md:p-8 rounded shadow border-t-4 border-teal-500">
        <div class="flex flex-wrap justify-between items-center mb-4">
            <h2 class="text-md font-medium">Event List</h2>
            <button id="openModal" class="bg-[#01a9ac] hover:bg-[#07e4e8] text-white text-xs px-3 py-2 transition-all duration-300">Add Event</button>
        </div>

        <div class="table-responsive">
            <table class="table table-bordered bg-white shadow-md w-full">
                <thead >
                <tr>
                    <th>Sr.</th>
                    <th>Event Name</th>
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                    <td class='py-3'>{$sr}</td>
                    <td class='py-3'>{$row['event_name']}</td>
                    <td class='py-3'>{$row['start_date']}</td>
                    <td class='py-3'>{$row['end_date']}</td>
                    <td class='py-3  text-center'>
                      <a href='delete_event.php?id={$row['id']}' class='bg-[#fe5d70] text-white px-3 py-2 text-xs hover:bg-[#fe5d70] transition-all duration-300' onclick='return confirm(\"Are you sure?\")'>Delete</a>
                    </td>
                  </tr>";
                    $sr++;
                }
    ...
    <!-- Modal -->
    <div id="modal" class="fixed inset-0 hidden bg-black bg-opacity-50 z-50 flex items-start justify-center overflow-y-auto">
        <div id="modalContent" class="bg-white w-full max-w-md mt-20 p-6 rounded shadow-lg slide-down relative">
            <div class="flex justify-between items-center mb-3">
                <h3 class="text-xl font-semibold">Personal Event</h3>
                <button id="closeModal" class="text-black text-xl font-bold">&times;</button>
            </div>
            <div class=" border-b mb-3"></div>

            <form action="add_event.php" class="space-y-6" method="POST">
                ...
                <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                    ...
                    <input type="text" name="event_name"  required
                           class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
                </div>



                <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4  relative">
                    <label class="text-gray-700 w-40 ">Start Date <span class="text-red-500">*</span></label>
                    <div class="w-full flex items-center  lg:ml-2 md:ml-2 sm:ml-0 ml-0 relative">
                        <input id="dobInput" name="start_date" placeholder="YYYY-MM" value="<?php echo date('Y-m-d'); ?>" readonly
                ...
                <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4 relative">
                    <label class="text-gray-700 w-40">End Date <span class="text-red-500">*</span></label>
                    <div class="w-full flex items-center lg:ml-2 md:ml-2 sm:ml-0 ml-0 relative">
                        <input id="dobInput1" name="end_date" placeholder="YYYY-MM"  value="<?php echo date('Y-m-d'); ?>" readonly
                               class="w-full px-3 py-2 border focus:outline-none focus:ring-2 focus:ring-teal-500">
                        <div class="absolute right-2 text-teal-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
                ...
                <div class="flex justify-end gap-2">
                    <button type="button" class="btn bg-gray-200 text-black rounded-none" id="closeModal2">Close</button>
                    <button type="submit" class="bg-[#01a9ac] hover:bg-[#07e4e8] text-white text-xs px-3 py-2 transition-all duration-300">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
