...
<div id="mainContent" class=" p-8 absolute top-1 ">
    <h1 class="font-semibold text-[24px]">Settings</h1>
    <span>
    <p class="text-[#919aa3] text-[14px] pt-2 float-left">General Settings</p>
    ...
    <div class=" mx-auto bg-white p-8 rounded shadow">
        <form class="space-y-4">
            ...
            <!-- Company Name (Inline Label + Input) -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px]  text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Company Name</label>
                <input type="text" value="Almahir Hub" placeholder="Company Name"
                       class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
            </div>

            <!-- Logo Upload -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Logo</label>
                <input type="file" class="form-control rounded-none  w-full" />
            </div>

            <!-- Email -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Email</label>
                <input type="email" value="zenoxujaj@mailinator.com" placeholder="Email"
                       class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
            </div>

            <!-- Address -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Address</label>
                <input type="email" value="zenoxujaj@mailinator.com" placeholder="Email"
                       class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
            </div>
            ...
            <!-- City -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">City</label>
                <input type="email" value="zenoxujaj@mailinator.com" placeholder="Email"
                       class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
            </div>
            ...
            <!-- Dropdown Field -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Country</label>
                <select class="selectpicker form-control rounded-none w-full"  data-live-search="true" title="Select Country">
            ...
            <!-- Dropdown Field -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Language</label>
                <select class="selectpicker form-control rounded-none w-full"  data-live-search="true" title="Select Country">
            ...
            <!-- Dropdown Field -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Currency</label>
                <select class="selectpicker form-control rounded-none w-full"  data-live-search="true" title="Select Country">
                    ...
                    <option selected>Pakistani Rupee (PKR)</option>
            ...
            <!-- Phone -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Phone</label>
                <input type="number" value="03027680291" placeholder="phone no."
                       class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
            </div>
            ...
            <!-- Hotline -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Hotline</label>
                <input type="text" value="Aut eos minus volup" placeholder="Hotline"
                       class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
            </div>
            ...
            <!-- Fax -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Fax</label>
                <input type="number" value="+1 (955) 911-1534" placeholder="Fax"
                       class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
            </div>
            ...
            <!-- Website -->
            <div class="lg:flex md:flex items-center lg:space-x-4 md:space-x-4">
                <label class="w-40 text-[15px] text-gray-700 sm:pb-2 pb-2 lg:pb-0 md:pb-0">Website</label>
                <input type="text" value="https://www.fuqupojarew.org.uk" placeholder="Website"
                       class="form-control w-full rounded-none border border-gray-300 focus:border-[#01a9ac]" />
            </div>
            ...
            <div class="text-start pt-4 lg:pl-[9.4rem] md:pl-[9.4rem] sm:pl-0 pl-0">
                <button type="submit"
                        class="bg-[#01a9ac] hover:bg-[#07e4e8] text-white px-6 py-2 ">
                    Save
                </button>
            </div>
